...
- The Settings tab includes a `Check for updates` button that invokes the configured updater check; an available update opens T2's confirmation modal before installation/reload.
