...
6. Implement ciphertext-only export/import, non-sensitive history, and real Settings controls.
7. Integrate updater settings, startup scheduling, confirmation UI, and reload behavior.
