...
Resolve the versioned envelope, KDF benchmark target, associated-data policy, and parser grammar. Do not begin Obsidian UI integration until pure-layer tests exist. The mb-core SQLite mirror needs a later bootstrap repair.
